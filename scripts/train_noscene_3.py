### train w/o Scene Context, w/o Traffic Encoder, w/o State Encoder ###
...
from mmt.models.mmt_noscene_3 import TrajectoryGenerator, TrajectoryDiscriminator # model
...
parser.add_argument('--state_type', default=0, type=int) # v0: no state, v1: acc+speed_ang, v2: acc, v3: acc+ang, v4: speed
