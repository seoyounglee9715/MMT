...
from mmt.models.mmt import TrajectoryGenerator, TrajectoryDiscriminator # traffic model 불러오기
...
def check_accuracy(
    ...
    with torch.no_grad():
        for batch in loader:
            ...
            non_linear_ped, loss_mask, seq_start_end, img 
            ) = batch
