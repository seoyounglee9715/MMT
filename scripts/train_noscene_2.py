### train w/o Scene Context, w/o Traffic Encoder###
...
from mmt.losses import gan_g_loss, gan_d_loss, l2_loss
from mmt.losses import displacement_error, final_displacement_error

from mmt.models.mmt_noscene_2 import TrajectoryGenerator, TrajectoryDiscriminator # model
from mmt.utils import int_tuple, bool_flag, get_total_norm, relative_to_abs, get_dset_path
...
parser.add_argument('--state_type', default=1, type=int) # v1: acc1+acc2+speed+ang, v2: acc1+acc2+speed, v3: acc1+acc2+ang, v4: speed
...
# Output
parser.add_argument('--output_dir', default=os.getcwd() + '/obs_12/wo_scene_2/state_v2/2')
parser.add_argument('--print_every', default=5, type=int)
parser.add_argument('--checkpoint_every', default=100, type=int)
parser.add_argument('--checkpoint_name', default='ckpt_noscene_2')
...
def main(args):
    ...
    print("initializing val dataset done")
...
def check_accuracy(
    ...
    with torch.no_grad():
        for batch in loader:
            ...
            pred_traj_gt, _, _,
            obs_traj_rel, pred_traj_gt_rel, 
            non_linear_ped, loss_mask, seq_start_end,  _
            ) = batch
